...
function peg$parse(input, options) {
  ...
  function peg$f37(fname, args) {    return mapFunc("Math."+fname+"("+((args||[]).join(","))+")");  }
  ...
  const typeMap = { number:"float", boolean:"bool", vec2:"vec2", vec3:"vec3", vec4:"vec4" };
  const jsFuncMap = {
